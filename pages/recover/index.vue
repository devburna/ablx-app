  ...
  <div class="container-fluid py-5 h-100">
    <div class="container h-100">
      <div class="row align-items-center justify-content-center h-100">
        <div class="col-lg-4">
          <form @submit.prevent="useAuth().recover(loginForm)" class="row g-3">
            <div class="col-lg-12">
              <h3>Account recovery</h3>
              <p>
                Your 12 word Secret Private Key Recovery Phrase grants access to
                your account. Please input it in the order specified.
              </p>
            </div>
            <div class="col-lg-12">
              <input
